...
class mmp_groups {
    ...
    /**
     * Liefert die Listen Ansicht zurück
     * @return mixed
     */
    public static function getList() {
        ...
        $list->setNoRowsMessage(rex_i18n::translate('groups_norowsmessage'));
        ...
        $list->setColumnLabel('name', rex_i18n::translate('groups_column_name'));
        $list->setColumnFormat('name', 'custom', function ($params) {
            ...
            $name .= '  <a href="'.$list->getUrl(['func' => 'delete', 'group_id' => $list->getValue('id')]).'" class="btn btn-delete" title="'.rex_i18n::translate('groups_action_delete').'" data-confirm="'.rex_i18n::translate('groups_action_delete').'?"><i class="rex-icon rex-icon-delete"></i></a>';
            $name .= '</span>';
            $name .= '</strong>';
    ...
    /**
     * Liefert die Editieren / Hinzufügen Maske zurück.
     * @param $func
     */
    public static function getEdit($func) {
        $group_id = rex_request('group_id', 'int');

        if ($func == 'edit') {
            $formLabel = rex_i18n::translate('groups_formcaption_edit');
        } elseif ($func == 'add') {
            $formLabel = rex_i18n::translate('groups_formcaption_add');
        }
        ...
        $field->setLabel(rex_i18n::translate('groups_label_name'));
        //End - add name-field
